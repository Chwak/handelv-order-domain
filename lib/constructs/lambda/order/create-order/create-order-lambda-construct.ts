...
export class CreateOrderLambdaConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: CreateOrderLambdaConstructProps) {
    ...
    const lambdaCodePath = path.join(__dirname, '../../../../functions/lambda/order/create-order/create-order-lambda.ts');
    this.function = new NodejsFunction(this, 'CreateOrderFunction', {
