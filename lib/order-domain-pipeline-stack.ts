 ...
 * 
 * Self-contained pipeline infrastructure for the order-domain domain:
...
export interface OrderDomainPipelineStackProps extends cdk.StackProps {
  domain: string;
...
export class OrderDomainPipelineStack extends cdk.Stack {
  public readonly artifactBucket: s3.Bucket;

  constructor(scope: Construct, id: string, props: OrderDomainPipelineStackProps) {
